...
import { Folder, FolderOpen, File, ChevronRight, ChevronDown, Search, X, FileText, Download, ChevronLeft, ShieldCheck } from 'lucide-react';
...
// import React, { useState, useEffect, useMemo, useCallback } from 'react';
// import { Folder, FolderOpen, File, ChevronRight, ChevronDown, Search, X, FileText, Calendar, User, Download, ArrowLeft, Eye, ChevronLeft } from 'lucide-react';
// import { useAuth } from "@/contexts/AuthContext";
// import { callSoapService } from "@/api/callSoapService";
...
//         const hasChildren = item.children?.length > 0;
//         const isCategory = item.type === 'folder' && level === 1;
//         const showBadge = item.count > 0; // Only show badge if count > 0
